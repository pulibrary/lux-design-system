...
test("has the Wiki Page Select", async ({ page }) => {
  ...
  await page.getByLabel("Wikipedia page").fill("Nikol")
  await page.waitForTimeout(3000)
  await expect(page.locator("body")).toContainText("Nikola")
  await page.getByLabel("Wikipedia page").press("ArrowDown")
  await page.getByLabel("Wikipedia page").press("ArrowDown")
  await page.getByLabel("Wikipedia page").press("Enter")
  await expect(page.getByLabel("Wikipedia page")).toHaveValue("Nikola Tesla")

  //  the hidden input slot gets updated with the value chosen
  await expect(page.locator("#wiki_id")).toHaveValue("21473")
  await expect(page.locator("#wiki_label")).toHaveValue("Nikola Tesla")
})
