...
On first installation you must run `npx playwright install && npx playwright install firefox && npx playwright install webkit` to get the browsers for playwright.
