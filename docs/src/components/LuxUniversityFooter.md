...
| `links` | Links are supplied via an array of objects containting `text` and `href` properties.  If no links are supplied then a default list is displayed. To remove all links pass an empty array. | `Array` | `-` |
